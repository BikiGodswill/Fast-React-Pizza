...
export default function Button({ children, disabled, to, type, onClick }) {
  ...
  const styles = {
    ...
    secondary:
      'inline-block rounded-full font-semibold tracking-wide uppercase transition-colors duration-300 hover:text-stone-800 hover:bg-stone-300 focus:bg-stone-300 focus:ring focus:text-stone-800 focus:ring-stone-200 focus:ring-offset-2 focus:outline-none disabled:cursor-not-allowed border-2 border-stone-300 px-4 py-2.5 md:px-6 md:py-3.5 ',
  };
  if (to) {
    return (
